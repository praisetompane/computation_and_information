...
class TestBracketsLinter(unittest.TestCase):
    ...
    def valid_code(self):
        valid_code = '''
                    ...
                    '''
        self.assertEqual(c_linter.lint(valid_code), True, 'Ensure valid code passes linting')
    def invalid_code(self):
        invalid_code = '''
                ...
                '''
        self.assertEqual(c_linter.lint(invalid_code), False, "Ensure invalid code fails linting")
