    ...
    def isCorrectClosingBracket(sourceCharacters: List[Char],
                                 stackedCharacters: List[Char],
                                 expectedOpeningBrace: Char) = stackedCharacters match {
    ...
    def isBalanced(sourceCharacters: List[Char], 
                   stackedCharacters: List[Char]): Boolean =  sourceCharacters match {
        ...
        case sourceHead :: sourceTail =>
            ...
            else if(sourceHead == ')') isCorrectClosingBracket(sourceTail, stackedCharacters, '(')
            else if(sourceHead == ']') isCorrectClosingBracket(sourceTail, stackedCharacters, '[')
