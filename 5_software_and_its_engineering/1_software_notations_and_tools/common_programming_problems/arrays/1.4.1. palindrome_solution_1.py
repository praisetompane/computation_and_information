...
def build_character_frequency(string_input):
    def get_character_number(character):
        ...
        if(a_ascii_number <= character_ascii_number and character_ascii_number <= z_ascii_number):
            return character_ascii_number - a_ascii_number # not sure about this substraction
        return -1 #non letter
